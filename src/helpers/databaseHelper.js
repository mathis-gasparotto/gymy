...
function formatPlans(plans) {
  ...
  return planIds.length > 0 ? planIds.reduce((acc, id, index) => {
    acc[id] = {}
...
function formatWorkouts(workouts) {
  ...
  return workoutIds.length > 0 ? workoutIds.reduce((workoutAcc, workoutId, index) => {
...
function formatExercises(exercises) {
  ...
  return exerciseIds.length > 0 ? exerciseIds.reduce((exerciseAcc, exerciseId, index) => {
...
function formatPerformances(performances) {
  ...
  return performanceIds.length > 0 ? performanceIds.reduce((performanceAcc, performanceId, index) => {
...
function formatSeries(series) {
  ...
  return serieIds.length > 0 ? serieIds.reduce((serieAcc, serieId) => {
