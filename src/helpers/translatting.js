export default () => ({
  ...
  translateSigninError(error, defaultMessage = null) {
    switch (error.message) {
      ...
      case 'Votre email n\'a pas encore été vérifiée. Un email de vérification vous a de nouveau été envoyé.':
        return error.message
      case 'Votre email n\'a pas encore été vérifiée. Un email de vérification vous a été déjà été envoyé.':
        return error.message
      default:
        return defaultMessage || 'Une erreur est survenue'
    }
